 ...
 * 
 */
public class ProtocoloRapiPago {

    public static final int idmediopago = 26;

    public ProtocoloRapiPago() {
    }
	...
	protected void validarParametros(String monto, String cliente,
		...
		if (monto.length() != 8)
			...
			throw new Exception("Parametro Invalido - La longitud del parametro 'CLIENTE' no es de 8 digitos ");
		else if (fechavto.length() != 6)
			throw new Exception("Parametro Invalido - La longitud del parametro 'FECHAVTO' no es de 8 digitos ");
		else if (recargo.length() != 7)
			throw new Exception("Parametro Invalido - La longitud del parametro 'RECARGO' no es de 7 digitos ");
			...
			throw new Exception("Parametro Invalido - La longitud del parametro 'COD_P1' no es de 3 digitos ");
		else if (cod_p2.length() != 4)
			throw new Exception("Parametro Invalido - La longitud del parametro 'COD_P2' no es de 4 digitos ");
		else if (cod_p3.length() != 2)
			throw new Exception("Parametro Invalido - La longitud del parametro 'COD_P3' no es de 2 digitos ");
		else if (cod_p4.length() != 3)
			throw new Exception("Parametro Invalido - La longitud del parametro 'COD_P4' no es de 3 digitos ");
			...
			throw new Exception("Parametro Invalido - El parametro 'CLIENTE' no es numerico ");
			...
			throw new Exception("Parametro Invalido - El parametro 'NRODOC' no es numerico ");
			...
			throw new Exception("Parametro Invalido - El parametro 'COD_P4' no es numerico ");
	}
}
